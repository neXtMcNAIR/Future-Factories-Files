...
{ 
	...
	IGuiDialogView
	{
		...
		IGuiGraphicButton
		{
			...
			Component.onCompleted:
			{
				proxy.initProxy(q486539350,486539350)
			}
		}
		IGuiAlarmView
		{
			...
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539351,486539351)
				}
			}
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539352,486539352)
				}
			}
			Component.onCompleted:
			{
	...
	IGuiDialogView
	{
		...
		IGuiGraphicButton
		{
			...
			Component.onCompleted:
			{
				proxy.initProxy(q486539353,486539353)
			}
		}
		IGuiAlarmView
		{
			...
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539354,486539354)
				}
			}
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539355,486539355)
				}
			}
			Component.onCompleted:
			{
	...
	IGuiDialogView
	{
		...
		IGuiGraphicButton
		{
			...
			Component.onCompleted:
			{
				proxy.initProxy(q486539356,486539356)
			}
		}
		IGuiAlarmView
		{
			...
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539357,486539357)
				}
			}
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539358,486539358)
				}
			}
			Component.onCompleted:
			{
